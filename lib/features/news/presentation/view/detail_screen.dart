...
class _DetailScreenState extends State<DetailScreen>
  ...
  void initState() {
    super.initState();
    context.read<NewsVoiceViewModel>().setLanguage('vi-VN');
    _voiceController =
        AnimationController(
          vsync: this,
  ...
  Widget _buildVoice(ThemeData theme, String content) =>
      Consumer<NewsVoiceViewModel>(
        builder: (_, state, child) {
          if (state.state == TtsState.playing &&
              state.isDifferent(widget.news)) {
